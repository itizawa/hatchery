...
| [0016](./0016-pivot-to-public-ai-community.md) | 公共型 AI コミュニティ（Reddit 風）への方針転換 | Accepted |
| [0017](./0017-domain-model-post-comment-score.md) | 公共コミュニティのドメインモデル（Community / Post / Comment / Subscription / score） | Accepted |
| [0018](./0018-engagement-permission-model.md) | 権限・関与モデル（ユーザー = 消費者 / ワーカー = 投稿者 / admin = 運営） | Accepted |
