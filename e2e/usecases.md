...
| post-thread | 投稿スレッド・upvote（`/posts/$postId`） | [post-thread/usecases.md](post-thread/usecases.md) | UC-POST-01〖12 |
...
- UC-POST-11: post / コメント本文の URL が自動リンク化される（#515）
- UC-POST-12: post / コメント本文の先頭 URL が OGP カードとして展開表示される（#515）
