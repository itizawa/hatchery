...
| [0016](./0016-channel-goal-output-contract.md) | チャンネル goal（出力契約）の導入 | Accepted |
| [0017](./0017-adopt-claude-agent-sdk-for-researcher.md) | goal=issue リサーチャーエンジンへの Claude Agent SDK 採用（ADR-0004 増補） | Accepted |
