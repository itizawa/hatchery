...
export function createApp(deps: AppDeps): Express {
  ...
  const batchRunLogRepository = deps.batchRunLogRepository ?? new InMemoryBatchRunLogRepository();
  ...
  app.use("/batch-logs", createBatchLogsRouter(batchRunLogRepository));
