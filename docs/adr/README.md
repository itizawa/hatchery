...
| [0030](./0030-weighted-single-community-batch.md) | 定時バッチを vote 重み付きランダムで 1 コミュニティのみ生成する方式へ変更（ADR-0009/0019 の生成方式を一部 supersede） | Accepted |
...
| [0033](./0033-monetization-community-patronage-and-worker-ownership.md) | マネタイズ方針: コミュニティ後援（パトロネージュ）とワーカー所有・登場優先プレミアム（ADR-0020/#331 を一部増補・ADR-0030 を堅持） | Accepted |
