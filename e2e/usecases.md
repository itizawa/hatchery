...
| admin | 管理画面（Worker / Community 管理, `/admin`）・ Worker 一覧ページネーション（#545）・トークン使用量コスト表示・日別コストグラフ（#664）・帰属シグナル（コミュニティ帰属・ロイヤリティスコア・Vote 分布, #761） | [admin/usecases.md](admin/usecases.md) | UC-ADMIN-01〇19 |
