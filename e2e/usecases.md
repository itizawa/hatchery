...
| legal | 利用規約・プライバシーポリシー（`/terms`・`/privacy`） | [legal/usecases.md](legal/usecases.md) | UC-LEGAL-01〜07 |
...
| pwa | PWA（manifest リンク・theme-color・Service Worker・ホーム画面追加）（#797） | [pwa/usecases.md](pwa/usecases.md) | UC-PWA-01〜06 |
